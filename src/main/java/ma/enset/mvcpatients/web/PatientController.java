package ma.enset.mvcpatients.web;
...
return patientRepository.findAll();    }
    ...
    public String save(Model model, @Validated Patient patient, BindingResult bindingResult,@RequestParam(defaultValue = "0")int page,@RequestParam(defaultValue = "") String keyword){
